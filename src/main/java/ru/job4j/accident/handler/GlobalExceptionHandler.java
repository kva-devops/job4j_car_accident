package ru.job4j.accident.handler;
...
import ru.job4j.accident.model.ErrorInfo;
...
public class GlobalExceptionHandler {
    ...
    private void setResponse(Exception e, HttpServletResponse response, String shortMessage) throws IOException {
        ...
        response.getWriter().write(mapper.writeValueAsString(
                new ErrorInfo(shortMessage, messagesMap.get("LongMessage"), messagesMap.get("Anchor")).getError()
        ));
    }
